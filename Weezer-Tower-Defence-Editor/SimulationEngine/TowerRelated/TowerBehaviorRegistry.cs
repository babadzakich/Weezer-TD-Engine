...
public class TowerBehaviorRegistry
{
    ...
    {
        Register("BasicTowerBehavior", () => new BasicTowerBehavior("basic_tower", "Basic Tower", new StandardBulletBehavior(25f, 10f, 1000f), 100, 150f, 1f));
    ...
    public ITowerBehavior Create(string behaviorType)
    {
        if (string.IsNullOrEmpty(behaviorType))
        {
            ...
            return new BasicTowerBehavior("basic_tower", "Basic Tower", new StandardBulletBehavior(25f, 300f, 500f), 100, 150f, 1f);
        }
