...
public class OrcEnemyType : IEnemyType
{
    ...
    public OrcEnemyType(int health, float speed, int damage, float hitRadius)
    {
        MaxHealth = health;
        this.health = health;
        this.speed = speed;
    ...
    {
        var texture = _texture ?? GetPlaceholderTexture(spriteBatch.GraphicsDevice);
        spriteBatch.Draw(
            texture,
            enemy.Position,
            null,
