...
public class TowerBehaviorRegistry
{
    ...
    {
        Register("BasicTowerBehavior", () => new BasicTowerBehavior("basic_tower", "Basic Tower", new SimulationEngine.BulletRelated.Behaviors.StandardBulletBehavior(25f, 300f, 500f), 100, 150f, 1f));
